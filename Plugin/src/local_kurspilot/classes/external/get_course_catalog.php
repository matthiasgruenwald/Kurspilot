 ...
 * local_coursepilot\external\get_course_catalog: local_kurspilot hat laut
 ...
 * dessen Klasse ist auf der lokal_kurspilot-Testinstanz (Spike, traegt
 * ausschliesslich local_kurspilot) ein Fatal Error ("Class ... not found",
