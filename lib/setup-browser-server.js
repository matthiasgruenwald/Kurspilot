...
function renderSetupPage(status, options = {}) {
  ...
  return (
    ...
    '        <p>Token erstellen oder erneuern: in Moodle die Webservice-Token-Verwaltung oeffnen, einen persoenlichen Token fuer den Kurspilot-Dienst anlegen und den Token direkt hier einfuegen.</p>\n' +
