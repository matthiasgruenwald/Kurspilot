...
function renderMoodleCard(status) {
  return (
    ...
    '    <h2>Moodle-Zugang</h2>\n' +
    '    <button class="card-edit" type="button" data-card-id="moodle">Ändern</button>\n' +
    '  </div>\n' +
...
function renderPlaceholderCard(cardId, title) {
  return (
    `<article class="card" data-card-id="${escapeHtml(cardId)}">\n` +
    '  <div class="card-header">\n' +
...
function renderWorkspaceCard(status) {
  return (
    ...
    '  <div class="card-header">\n' +
    '    <h2>Arbeitsordner</h2>\n' +
    '    <button class="card-edit" type="button" data-card-id="workspace">Ändern</button>\n' +
    '  </div>\n' +
    ...
    '    </label>\n' +
    '    <button class="choose-workspace-button" type="button">Ordner wählen…</button>\n' +
...
function renderClientsCard(status) {
  ...
  return (
    ...
    '  <div class="card-header">\n' +
    '    <h2>KI-Clients</h2>\n' +
    (choices ? '    <button class="card-edit" type="button" data-card-id="clients">Ändern</button>\n' : '') +
    '  </div>\n' +
...
function renderCropBackendCard(status) {
  ...
  return (
    ...
    (bothAvailable ? '    <button class="card-edit" type="button" data-card-id="crop-backend">Ändern</button>\n' : '') +
    '  </div>\n' +
...
function renderVersionCard() {
  return (
    ...
    '    <button class="version-check-button" type="button" data-action="check">erneut prüfen</button>\n' +
    '  </div>\n' +
    '</article>\n'
  );
}
...
function renderMaintenancePage(status) {
  return (
    ...
    '  <style>\n' +
    '    body { font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif; margin: 0; background: #f7f9fb; color: #1f2933; line-height: 1.5; }\n' +
    '    .maintenance-header { display: flex; flex-wrap: wrap; align-items: baseline; justify-content: space-between; gap: 0.5rem 1rem; max-width: 1100px; margin: 0 auto; padding: 1.75rem 1.5rem 0.5rem; }\n' +
    '    .maintenance-header h1 { margin: 0; font-size: 1.9rem; line-height: 1.2; }\n' +
    '    .maintenance-header .subtitle { margin: 0; color: #52606d; }\n' +
    '    .status-line { margin: 0; color: #107c10; font-weight: 600; white-space: nowrap; }\n' +
    '    main { max-width: 1100px; margin: 0 auto; padding: 1rem 1.5rem 2rem; }\n' +
    '    .card-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1rem; align-items: stretch; }\n' +
    '    .card { display: flex; flex-direction: column; background: #fff; border: 1px solid #d5dce3; border-radius: 8px; padding: 1rem 1.25rem; }\n' +
    ...
    '    .card-summary { margin: 0.4rem 0 0; color: #52606d; }\n' +
    '    .card-edit { background: transparent; border-color: transparent; color: #0a66ff; padding: 0.2rem 0.4rem; }\n' +
    '    .card-detail { margin-top: 0.75rem; display: grid; gap: 0.5rem; }\n' +
    '    .card-detail label { display: grid; gap: 0.2rem; font-size: 0.9rem; font-weight: 600; }\n' +
    '    .card-detail input { font: inherit; font-weight: 400; padding: 0.4rem 0.55rem; border: 1px solid #d5dce3; border-radius: 4px; box-sizing: border-box; width: 100%; }\n' +
    '    .card-save-status { margin: 0; color: #52606d; font-size: 0.9rem; }\n' +
    '    .card-path { word-break: break-all; }\n' +
    '    .radio-choice { display: flex; align-items: center; gap: 0.4rem; font-weight: 400; }\n' +
    '    .radio-choice input { width: auto; }\n' +
    '    .checkbox-choice { display: flex; align-items: center; gap: 0.4rem; font-weight: 400; }\n' +
    '    .checkbox-choice input { width: auto; }\n' +
    '    .card-restart { display: grid; gap: 0.4rem; margin-top: 0.5rem; }\n' +
    '    .card-restart:empty { margin-top: 0; }\n' +
    '    .restart-notice { margin: 0; color: #52606d; font-size: 0.9rem; }\n' +
    '    .restart-client-status { margin-left: 0.5rem; color: #52606d; font-size: 0.9rem; }\n' +
    '    .version-result { margin: 0; color: #52606d; font-size: 0.9rem; }\n' +
    '    .maintenance-footer { display: flex; flex-wrap: wrap; align-items: center; justify-content: space-between; gap: 0.75rem; max-width: 1100px; margin: 0 auto; padding: 1rem 1.5rem 2.5rem; }\n' +
    '    button { font: inherit; padding: 0.55rem 0.9rem; border: 1px solid #d5dce3; border-radius: 4px; cursor: pointer; }\n' +
    '    .btn-primary { background: #0a66ff; color: #fff; border-color: #0a66ff; }\n' +
    '    .btn-abort { background: #e4e7eb; color: #1f2933; }\n' +
    '    .btn-restart-setup { background: transparent; color: #52606d; border-color: transparent; text-decoration: underline; padding: 0.4rem 0.5rem; }\n' +
    '    #abort-status { margin-left: 0.75rem; color: #52606d; }\n' +
    '  </style>\n' +
    '</head>\n' +
    '<body>\n' +
    ...
    renderPlaceholderCard('activities', 'Aktivitäten') +
    ...
    '    <div>\n' +
    '      <button id="abort-button" class="btn-abort" type="button">⏻ Dienst beenden</button>\n' +
    '      <span id="abort-status" role="status" aria-live="polite"></span>\n' +
    '    </div>\n' +
    '    <button id="restart-setup-button" class="btn-restart-setup" type="button">↩ Ersteinrichtung wiederholen</button>\n' +
    '  </footer>\n' +
    '  <script>\n' +
