...
function renderUpdateSection() {
  return (
    ...
    '  <div id="update-status" role="status" aria-live="polite">Prüfe auf Updates...</div>\n' +
...
function renderSetupPage(status, selection, options = {}) {
  ...
  return (
    ...
    '        }\n' +
    '      }\n' +
    '      document.getElementById("check-updates-button")?.addEventListener("click", () => runUpdateCheck());\n' +
    '      runUpdateCheck();\n' +
    '    </script>\n' +
    '  </main>\n' +
    '</body>\n' +
