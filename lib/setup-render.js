...
function renderCropBackendCard(status) {
  ...
  return (
    ...
    '    <h2>Bildbearbeitung</h2>\n' +
      (bothAvailable ? '    <button class="card-edit btn-tertiary" type="button" data-card-id="crop-backend" aria-expanded="false">Ändern</button>\n' : '') +
    '  </div>\n' +
...
function renderMaintenancePage(status) {
  return (
    ...
    renderVersionCard() +
    '        <div class="card-column-actions card-column-actions--end">\n' +
