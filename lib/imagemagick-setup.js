...
/**
 * Loest den ausfuehrbaren magick-Befehl auf: 'magick' (PATH) auf macOS/Linux
 * immer, auf Windows nur wenn nicht im Kurspilot-Verzeichnis gefunden -
 * sonst der volle Pfad zur Kurspilot-eigenen Installation (Issue #145: ohne
 * das landet ein PATH-loses, per Setup installiertes ImageMagick weder im
 * Crop-Tool noch in der Statuspruefung).
 *
 ...
 * @returns {string} 'magick', 'convert' oder ein voller Pfad
 */
