...
/**
 * Prueft per `brew --version`, ob Homebrew auf diesem System installiert ist.
 *
 * @param {object} [options]
 * @param {Function} [options.execFileSync] austauschbar fuer Tests
 * @returns {boolean}
...
function installImageMagickMacOS(options = {}) {
  ...
  if (!isHomebrewInstalled(options)) {
    try {
  ...
  try {
    run('brew', ['install', 'imagemagick'], { stdio: ['ignore', 'ignore', 'pipe'] });
