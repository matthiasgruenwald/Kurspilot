 ...
 *
 * Hinweis zur Spec: docs/specs/0005 nennt an einer Stelle total:4; massgeblich
 * ist hier die Issue-#202-Vorgabe "{done, total} ueber die Minimum-Bedingungen",
 * also alle 5 Bedingungen von isMinimumConfigured (total:5). Dadurch gilt die
 * Invariante isMinimumConfigured(status) === (done === total).
 */
