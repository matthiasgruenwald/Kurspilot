...
const { writeKurspilotWorkspaceSetting } = require('./kurspilot-workspace-config');
 ...
 * @param {string[]} [options.selectedActivityIds] Aktivitaets-MCP-Auswahl fuer die Client-Konfiguration
