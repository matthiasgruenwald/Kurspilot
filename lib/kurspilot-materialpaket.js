 ...
 * Dateien in "eingeschlossen" und "ausgeschlossen" (mit Grund). Duenner
 * Wrapper um die geteilte Traversierung aus kurspilot-paket-tree.js mit der
 * fuer Materialpakete geltenden Ausschlussregel (evaluateExclusionReason).
 *
...
function walkVorhabenTree(vorhabenDir) {
  return walkPaketTree(vorhabenDir, evaluateExclusionReason);
}
