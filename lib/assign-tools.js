...
const ASSIGN_TOOLS = [
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        onlinetext_enabled: { type: "number", enum: [0, 1], description: "Online-Text aktivieren, weglassen = nicht ändern" },
        onlinetext_wordlimit_enabled: { type: "number", enum: [0, 1], description: "Wortlimit aktivieren, weglassen = nicht ändern" },
        onlinetext_wordlimit: { type: "number", description: "Maximale Wörter, weglassen = nicht ändern" },
        submission_file_enabled: { type: "number", enum: [0, 1], description: "Dateiabgabe aktivieren, weglassen = nicht ändern" },
        submission_file_maxfiles: { type: "number", description: "Maximale Dateien je Abgabe, weglassen = nicht ändern" },
        submission_file_maxsizebytes: { type: "number", description: "Maximale Dateigröße in Bytes, weglassen = nicht ändern" },
        submission_file_filetypes: { type: "string", description: "Akzeptierte Moodle-Dateitypen, leer lassen = nicht ändern" },
        feedback_comments_enabled: { type: "number", enum: [0, 1], description: "Feedback-Kommentare, weglassen = nicht ändern" },
        feedback_editpdf_enabled: { type: "number", enum: [0, 1], description: "PDF-Annotation, weglassen = nicht ändern" },
        feedback_file_enabled: { type: "number", enum: [0, 1], description: "Feedback-Dateien, weglassen = nicht ändern" },
        feedback_file_maxfiles: { type: "number", description: "Maximale Feedback-Dateien, weglassen = nicht ändern" },
        feedback_file_maxsizebytes: { type: "number", description: "Maximale Größe von Feedback-Dateien in Bytes, weglassen = nicht ändern" },
        feedback_file_filetypes: { type: "string", description: "Akzeptierte Feedback-Dateitypen, leer lassen = nicht ändern" },
        feedback_offline_enabled: { type: "number", enum: [0, 1], description: "Offline-Bewertungsbogen, weglassen = nicht ändern" },
      },
      required: ["cmid"],
    },
    async handler(args, callMoodle) {
      return await callMoodle("local_coursepilot_update_assign", {
        ...
        onlinetext_enabled: args.onlinetext_enabled ?? -1,
        onlinetext_wordlimit_enabled: args.onlinetext_wordlimit_enabled ?? -1,
        onlinetext_wordlimit: args.onlinetext_wordlimit ?? -1,
        submission_file_enabled: args.submission_file_enabled ?? -1,
        submission_file_maxfiles: args.submission_file_maxfiles ?? -1,
        submission_file_maxsizebytes: args.submission_file_maxsizebytes ?? -1,
        submission_file_filetypes: args.submission_file_filetypes || "",
        feedback_comments_enabled: args.feedback_comments_enabled ?? -1,
        feedback_editpdf_enabled: args.feedback_editpdf_enabled ?? -1,
        feedback_file_enabled: args.feedback_file_enabled ?? -1,
        feedback_file_maxfiles: args.feedback_file_maxfiles ?? -1,
        feedback_file_maxsizebytes: args.feedback_file_maxsizebytes ?? -1,
        feedback_file_filetypes: args.feedback_file_filetypes || "",
        feedback_offline_enabled: args.feedback_offline_enabled ?? -1,
      });
    },
  },
  {
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        onlinetext_enabled: { type: "number", enum: [0, 1], description: "Online-Text aktivieren", default: 1 },
        onlinetext_wordlimit_enabled: { type: "number", enum: [0, 1], description: "Wortlimit aktivieren", default: 0 },
        onlinetext_wordlimit: { type: "number", description: "Maximale Wörter", default: 0 },
        submission_file_enabled: { type: "number", enum: [0, 1], description: "Dateiabgabe aktivieren; weglassen = aus maxfiles ableiten" },
        submission_file_maxfiles: { type: "number", description: "Maximale Dateien je Abgabe", default: 1 },
        submission_file_maxsizebytes: { type: "number", description: "Maximale Dateigröße in Bytes (0 = Moodle-Standard)", default: 0 },
        submission_file_filetypes: { type: "string", description: "Akzeptierte Moodle-Dateitypen", default: "" },
        feedback_comments_enabled: { type: "number", enum: [0, 1], description: "Feedback-Kommentare", default: 1 },
        feedback_editpdf_enabled: { type: "number", enum: [0, 1], description: "PDF-Annotation", default: 0 },
        feedback_file_enabled: { type: "number", enum: [0, 1], description: "Feedback-Dateien", default: 0 },
        feedback_file_maxfiles: { type: "number", description: "Maximale Feedback-Dateien", default: 1 },
        feedback_file_maxsizebytes: { type: "number", description: "Maximale Größe von Feedback-Dateien in Bytes", default: 0 },
        feedback_file_filetypes: { type: "string", description: "Akzeptierte Feedback-Dateitypen", default: "" },
        feedback_offline_enabled: { type: "number", enum: [0, 1], description: "Offline-Bewertungsbogen", default: 0 },
      },
    ...
    async handler(args, callMoodle) {
      return await callMoodle("local_coursepilot_create_assign", {
        ...
        onlinetext_enabled: args.onlinetext_enabled ?? 1,
        onlinetext_wordlimit_enabled: args.onlinetext_wordlimit_enabled ?? 0,
        onlinetext_wordlimit: args.onlinetext_wordlimit ?? 0,
        submission_file_enabled: args.submission_file_enabled ?? -1,
        submission_file_maxfiles: args.submission_file_maxfiles ?? args.maxfiles ?? 1,
        submission_file_maxsizebytes: args.submission_file_maxsizebytes ?? 0,
        submission_file_filetypes: args.submission_file_filetypes || "",
        feedback_comments_enabled: args.feedback_comments_enabled ?? 1,
        feedback_editpdf_enabled: args.feedback_editpdf_enabled ?? 0,
        feedback_file_enabled: args.feedback_file_enabled ?? 0,
        feedback_file_maxfiles: args.feedback_file_maxfiles ?? 1,
        feedback_file_maxsizebytes: args.feedback_file_maxsizebytes ?? 0,
        feedback_file_filetypes: args.feedback_file_filetypes || "",
        feedback_offline_enabled: args.feedback_offline_enabled ?? 0,
      });
    },
  },
];
