 ...
 * unter `local-context/`, siehe CONTEXT.md "Arbeitsbereich-Ort").
 *
 ...
 * @returns {{ok: true, contextRoot: string, documents: object[], availableDocuments: object[], missingDocuments: object[]}|{ok: false, message: string}}
 */
