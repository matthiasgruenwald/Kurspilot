  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        timeopen:  { type: "number", description: "Öffnungszeitpunkt als Unix-Timestamp (0 = kein Limit). -1 = nicht ändern.", default: -1 },
        timeclose: { type: "number", description: "Schließzeitpunkt als Unix-Timestamp (0 = kein Limit). -1 = nicht ändern.", default: -1 },
      },
      required: ["cmid"],
    },
    async handler(args, callMoodle) {
